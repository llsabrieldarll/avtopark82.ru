    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        ...
        <SettingsLayout>
            <div class="flex flex-col space-y-6">
                <HeadingSmall title="Информация профиля" description="Обновление имени пользователя и почты" />

                <form @submit.prevent="submit" class="space-y-6">
                    <div class="grid gap-2">
                        <Label for="name">Имя</Label>
                        <Input id="name" class="mt-1 block w-full" v-model="form.name" required autocomplete="name" placeholder="Полное имя (Иванов Иван)" />
